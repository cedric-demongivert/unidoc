...
export class HasTagOfAnyType implements UnidocAssertion {
  /**
  ...
  */
  public next (event: UnidocEvent) : boolean {
    this._state = this._state || event.type === UnidocEventType.START_TAG
    return this._state
  }
  ...
  */
  public clone () : HasTagOfAnyType {
    const result : HasTagOfAnyType = new HasTagOfAnyType()
