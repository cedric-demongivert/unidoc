       ...
       implements UnaryOperator<boolean, boolean>
{
  ...
  */
  public clone () : WasFalsyQuery {
    const result : WasFalsyQuery = new WasFalsyQuery(this.operand.clone())
  ...
  */
  public toString () : string {
    return 'WAS ' + this.operand.toString() + ' FALSY'
  }
}
