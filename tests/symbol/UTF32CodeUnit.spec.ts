...
describe('UTF32CodeUnit', function () {
  describe('#fromUTF16CodePoint', function () {
    ...
    it('return the given code unit if it is a non-surrogate code unit', function () {
      expect(UTF32CodeUnit.fromUTF16CodePoint(0x00E9)).toBe(0x000000E9)
    })

    // @see https://www.compart.com/fr/unicode/U+1F9B0
    it('return the utf32 code unit when a surrogate pair was given', function () {
  ...
  describe('#toString', function () {
    // @see https://www.compart.com/fr/unicode/U+00E9
    it('return a string representation of non-surrogated characters', function () {
      expect(UTF32CodeUnit.toString(0x000000E9)).toBe('é')
    })

    // @see https://www.compart.com/fr/unicode/U+1F9B0
    it('return a string representation of surrogated characters', function () {
