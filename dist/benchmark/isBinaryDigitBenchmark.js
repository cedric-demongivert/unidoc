...
/***/ "./benchmark/isBinaryDigitBenchmark.ts":
/*!*********************************************!*\
  !*** ./benchmark/isBinaryDigitBenchmark.ts ***!
  \*********************************************/
...
var chars = [ZERO, ONE, A, B];
var suite = new benchmark__WEBPACK_IMPORTED_MODULE_0__.Suite();

function isBinaryDigitWithSwitch(symbol) {
  switch (symbol) {
    case ZERO:
    case ONE:
      return true;
...
function isBinaryDigitWithRange(symbol) {
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./benchmark/isBinaryDigitBenchmark.ts");
