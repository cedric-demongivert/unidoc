...
/***/ "./benchmark/isDecimalDigitBenchmark.ts":
/*!**********************************************!*\
  !*** ./benchmark/isDecimalDigitBenchmark.ts ***!
  \**********************************************/
...
/* harmony import */ var benchmark__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! benchmark */ "./node_modules/benchmark/benchmark.js");
...
var ONE = '1'.codePointAt(0);
var TWO = '2'.codePointAt(0);
var THREE = '3'.codePointAt(0);
var FOUR = '4'.codePointAt(0);
var FIVE = '5'.codePointAt(0);
var SIX = '6'.codePointAt(0);
var SEVEN = '7'.codePointAt(0);
var EIGHT = '8'.codePointAt(0);
var NINE = '9'.codePointAt(0);
var A = 'A'.codePointAt(0);
var B = 'B'.codePointAt(0);
var C = 'C'.codePointAt(0);
var D = 'D'.codePointAt(0);
var E = 'E'.codePointAt(0);
var F = 'F'.codePointAt(0);
var G = 'G'.codePointAt(0);
var H = 'H'.codePointAt(0);
var I = 'I'.codePointAt(0);
var J = 'J'.codePointAt(0);
var chars = [ZERO, ONE, TWO, THREE, FOUR, FIVE, SIX, SEVEN, EIGHT, NINE, A, B, C, D, E, F, G, H, I, J];
var suite = new benchmark__WEBPACK_IMPORTED_MODULE_0__.Suite();

function isDecimalDigitWithSwitch(symbol) {
  switch (symbol) {
    case ZERO:
    case ONE:
    case TWO:
...
function isDecimalDigitWithRange(symbol) {
  return symbol >= ZERO && symbol <= NINE;
}

suite.add('#isDigitWithSwitch', function () {
  var symbol = chars[Math.floor(Math.random() * chars.length)];
...
suite.on('complete', function () {
  this.forEach(function print(value) {
    console.log(value.name + ' executed ' + benchmark__WEBPACK_IMPORTED_MODULE_0__.formatNumber(value.count) + ' times');
    console.log('  average execution time: ' + benchmark__WEBPACK_IMPORTED_MODULE_0__.formatNumber(value.stats.variance));
    console.log('  variance: ' + benchmark__WEBPACK_IMPORTED_MODULE_0__.formatNumber(value.stats.variance));
    console.log('  deviation: ' + benchmark__WEBPACK_IMPORTED_MODULE_0__.formatNumber(value.stats.variance));
  });
...
;(function() {
  ...
  var freeDefine = __webpack_require__.amdD;
  ...
  function runInContext(context) {
    ...
    function createFunction() {
      ...
      createFunction = function(args, body) {
        var result,
            anchor = __webpack_require__.amdD ? __webpack_require__.amdO : Benchmark,
            prop = uid + 'createFunction';

        runScript((__webpack_require__.amdD ? 'define.amd.' : 'Benchmark.') + prop + '=function(' + args + '){' + body + '}');
        result = anchor[prop];
        delete anchor[prop];
        return result;
      };
    ...
    function require(id) {
      try {
        var result = freeExports && __webpack_require__("./node_modules/benchmark sync recursive")(id);
      } catch(e) {}
      return result || null;
    }
    ...
    function runScript(code) {
      var anchor = __webpack_require__.amdD ? __webpack_require__.amdO : Benchmark,
          script = doc.createElement('script'),
          sibling = doc.getElementsByTagName('script')[0],
          parent = sibling.parentNode,
          prop = uid + 'runScript',
          prefix = '(' + (__webpack_require__.amdD ? 'define.amd.' : 'Benchmark.') + prop + '||function(){})();';
  ...
  if (true) {
    ...
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js"), __webpack_require__(/*! platform */ "./node_modules/platform/platform.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(_, platform) {
      return runInContext({
        '_': _,
        'platform': platform
      });
...
/***/ "./node_modules/benchmark sync recursive":
/*!**************************************!*\
  !*** ./node_modules/benchmark/ sync ***!
  \**************************************/
/***/ ((module) => {
...
webpackEmptyContext.id = "./node_modules/benchmark sync recursive";
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./benchmark/isDecimalDigitBenchmark.ts");
