...
/***/ "./benchmark/isWhitespaceBenchmark.ts":
/*!********************************************!*\
  !*** ./benchmark/isWhitespaceBenchmark.ts ***!
  \********************************************/
...
var CARRIAGE_RETURN = '\r'.codePointAt(0);
var NEW_LINE = '\n'.codePointAt(0);
var FORM_FEED = '\f'.codePointAt(0);
var TABULATION = '\t'.codePointAt(0);
...
var chars = [CARRIAGE_RETURN, NEW_LINE, FORM_FEED, TABULATION, SPACE, A, B, C, D, E];
var suite = new benchmark__WEBPACK_IMPORTED_MODULE_0__.Suite();

function isWhitespaceWithSwitch(symbol) {
  switch (symbol) {
...
function isWhitespaceWithDisjunction(symbol) {
  return symbol === CARRIAGE_RETURN || symbol === NEW_LINE || symbol === FORM_FEED || symbol === TABULATION || symbol === SPACE;
}
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./benchmark/isWhitespaceBenchmark.ts");
